...
public class Question{
    ...
    // Include the following validations
        ...
        public Question(String questionText,List<String> choices,String answer){
                if(questionText.isEmpty() || questionText==null)System.out.println("Question text cannot be null or empty!");
                else if(choices.isEmpty() || choices==null)System.out.println("Choices cannot be null or empty!");
                else if(answer.isEmpty() || answer==null)System.out.println("Answer cannot be null or empty!");
                else if(!choices.contains(answer))System.out.println("Answer is not present among the choices!");
                else{
                        this.answer=answer;
    ...
    //TODO: Create the method checkAnswer() with signature: public boolean checkAnswer(String answer)
        ...
        public boolean checkAnswer(String answerText){
                return answerText.equals(this.answer);
        }
